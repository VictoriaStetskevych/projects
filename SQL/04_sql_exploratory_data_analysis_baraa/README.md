...
FROM [gold.fact_sales];
```
Result:<br> 16_total_sales.png?raw=true
...
FROM [gold.fact_sales];
```
Result:<br> 18_average_price.png?raw=true
...
FROM [gold.fact_sales];
```
Result:<br> 19_total_orders.png?raw=true
...
```
Result:<br> 18484
12_total_customers.png?raw=true
